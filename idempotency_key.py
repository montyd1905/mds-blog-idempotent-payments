...
class PaymentIdentikit:
    ...
    def generate_idempotency_key(
        ...
        The key is generated by hashing a concatenated string of all
        identikit components. This ensures that:
        ...
        Returns:
            A hexadecimal string representing the idempotency key
        """
        timecode = self.generate_timecode(transaction_time)
        
        # Build the identikit string in a consistent order
        # Format: RBC|RAN|SBC|SAN|TTC|TAMT|ITN|CTYPE|CID|CLOC
        identikit_string = "|".join([
        ...
        hash_obj.update(identikit_string.encode('utf-8'))
